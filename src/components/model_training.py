...
from utils import model_feature,RMSE,get_disaggregated_metrics,split_data,train_model,lolo_valid,save_object
...
class MODEL_TRAINER:
    ...
    def initiate_model_trainer(self,train_data,test_data):
        try:
            ...
            #savee model
            save_object(file_path=self.model_train_config.model_train_config, obj=model)
